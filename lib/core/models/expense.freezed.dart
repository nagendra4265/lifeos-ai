...
class _$ExpenseImpl implements _Expense {
  ...
  @override
  String toString() {
    return 'Expense(id: $id, title: $title, amount: $amount, date: $date, category: $category, note: $note)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, amount, date, category, note);
...
abstract class _Expense implements Expense {
  const factory _Expense(
      ...
      @HiveField(5) final String? note}) = _$ExpenseImpl;
