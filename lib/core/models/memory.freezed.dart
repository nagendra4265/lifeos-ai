...
class _$MemoryImpl implements _Memory {
  ...
  @override
  String toString() {
    return 'Memory(id: $id, title: $title, date: $date, images: $images, category: $category)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, date,
      const DeepCollectionEquality().hash(_images), category);
...
abstract class _Memory implements Memory {
  const factory _Memory(
      ...
      @HiveField(3) final List<String>? images,
      @HiveField(4) final String? category}) = _$MemoryImpl;
