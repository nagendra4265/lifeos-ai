...
class _$TaskImpl implements _Task {
  const _$TaskImpl(
      ...
      @HiveField(5) this.priority = 'Normal'});
  ...
  @override
  String toString() {
    return 'Task(id: $id, title: $title, subtitle: $subtitle, isCompleted: $isCompleted, dueDate: $dueDate, priority: $priority)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, subtitle, isCompleted, dueDate, priority);
...
abstract class _Task implements Task {
  const factory _Task(
      ...
      @HiveField(5) final String priority}) = _$TaskImpl;
